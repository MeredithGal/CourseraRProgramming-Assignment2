## This function produces a “matrix” object that can store or cache its inverse
## if det(A) != 0, then inverse exists

## Notice the superassignment operator <<-
## Used within a lexical scope, where an environment stores the state for a function or set of functions that modify the state by using superassignment.
